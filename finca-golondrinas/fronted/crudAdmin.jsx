  ...
  return (
    ...
    <><><><nav class="navbar navbar-expand-lg bg-light">
      <div className="container-fluit">
        <a class="navbar-brand" href="#"><h1>Administrador</h1></a>
        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          <ul className="navbar-nav">
            ...
            <li className="nav-item">
              <button className="nav-link" href="View/Golondrina/index.php">Salir</button> 
            </li>
          </ul>
        </div>
      </div>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  ...
                  classname="edit" href="view/Editar.php?id=<?php echo $dato[" _id
                  >
                    Editar

                  </button>{" "}
                  <button color = "danger" classname="edit" href="Controller/delete.php?id=<?php echo $dato[" _id
                  >
                    Eliminar
                  </button>{" "}
                </td>
